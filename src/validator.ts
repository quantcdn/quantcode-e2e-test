 ...
 *
 * This is a format check only, not a sanitiser — callers still need to encode
 * or escape the value before rendering or storing it.
 */
 ...
 *
 * Ports are permitted. This is a format check only, not a sanitiser.
 */
